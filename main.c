...
void welcomePage(){
    ...
    printf("\n\n\n\n\tDevelopped by: \n\n\n\t\t1. BUHENDWA ASIFIWE Ange\t\t25864\n\t\t2. EFFATA MUSHI-MUNTU-NKANA DON BENI\t25900\n\t\t3. INGABIRE BIENVENU \t\t\t26117\n\t\t4. KAJIBWAMI BARAKA JOEL \t\t26091\n\t\t5. VICTOR URYEM JACKER \t\t\t26049");
...
void adminlogin(bool test){
    char adminuserName[6][9] = {"ange", "don", "admin", "kenny", "victor", "joel"};
    char adminPassword [6][9] = {"ange", "don", "admin","kenny", "victor", "joel"};
